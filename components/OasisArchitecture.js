            ...
            <div className="container">
                <div className="row">
                    <div className="col-lg-8 offset-lg-2">
                        ...
                        <br/><br/>
                        See our full <a href="/components/OasisArchitecture.js">product suite</a> for more information.</p>
                        <img src="/static/images/oasis-platform-arch.png" alt="" className="img-fluid-2" />
                    </div>
